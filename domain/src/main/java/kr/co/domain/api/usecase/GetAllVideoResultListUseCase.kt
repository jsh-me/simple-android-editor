...
class GetAllVideoResultListUseCase(retrofitRepository: RetrofitRepository) {
    private val fileService = retrofitRepository
        .getRetrofit()
        .create(FileService::class.java)

    fun getAllVideoResult(): Single<AllVideoResultResponse> = fileService
        .getAllVideoResultList()
